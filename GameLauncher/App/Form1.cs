    ...
    public partial class mainScreen : Form {
        ...
        private void mainScreen_Load(object sender, EventArgs e) {
            ...
            try {
                ...
                string serverurl = "https://launcher.soapboxraceworld.ml/serverlist.txt";
        ...
        private void githubLink_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e) {
            ...
            Process.Start("https://discord.gg/RneBfcj");
        }
        ...
        private void launchNFSW() {
            ...
            try {
                if(String.IsNullOrEmpty(SettingFile.Read("Language"))) {
                    ...
                    WebClient wc = new WebClientWithTimeout();
                    string response = wc.DownloadString("https://download.soapboxraceworld.ml/" + SettingFile.Read("Language").ToLower() + "/index.xml");
        ...
        public void DownloadCoreFiles() {
            ...
            if (!File.Exists(SettingFile.Read("InstallationDirectory") + "\\nfsw.exe")) {
                ...
                downloader.StartDownload("https://download.soapboxraceworld.ml", "", SettingFile.Read("InstallationDirectory"), false, false, 1130632198);
            } else {
                DownloadTracksFiles();
            }
        }
        ...
        public void DownloadTracksFiles() {
            ...
            if (!File.Exists(SettingFile.Read("InstallationDirectory") + "\\Tracks\\STREAML5RA_98.BUN")) {
                ...
                downloader.StartDownload("https://download.soapboxraceworld.ml/", "Tracks", SettingFile.Read("InstallationDirectory"), false, false, 615494528);
            } else {
                DownloadSpeechFiles();
            }
        }
        ...
        public void DownloadSpeechFiles() {
            ...
            if (!File.Exists(SettingFile.Read("InstallationDirectory") + "\\Sound\\Speech\\copspeechsth_" + speechFile + ".big")) {
                ...
                downloader.StartDownload("https://download.soapboxraceworld.ml", speechFile, SettingFile.Read("InstallationDirectory"), false, false, speechSize);
            } else {
        ...
        public void DownloadTracksHighFiles() {
            ...
            if (SettingFile.Read("TracksHigh") == "1" && !File.Exists(SettingFile.Read("InstallationDirectory") + "\\TracksHigh\\STREAML5RA_98.BUN")) {
                ...
                downloader.StartDownload("https://download.soapboxraceworld.ml", "TracksHigh", SettingFile.Read("InstallationDirectory"), false, false, 278397707);
            } else {
                OnDownloadFinished();
            }
        }
