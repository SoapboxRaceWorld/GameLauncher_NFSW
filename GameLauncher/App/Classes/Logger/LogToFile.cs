...
namespace GameLauncher.App.Classes.Logger
{
    ...
    class LogVerify
    {
        ...
        public static void StartVerifyLogging()
        {
            Task.Run(() => VerifyTaskKernel());
        }
        ...
        public static void Valid(string text)
        {
            _toFile(text, "   VAILD");
        }

        public static void Invalid(string text)
        {
            _toFile(text, " INVALID");
        }

        public static void Deleted(string text)
        {
            _toFile(text, " DELETED");
        }

        public static void Missing(string text)
        {
            _toFile(text, " MISSING");
        }

        public static void Downloaded(string text)
        {
            _toFile(text, "REPLACED");
        }
