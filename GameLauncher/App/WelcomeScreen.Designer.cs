namespace GameLauncher.App
{
    partial class WelcomeScreen
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.WelcomeText.Text = "Howdy! Looks like it\'s the first time this launcher is started. Please press OK a" +
    "nd specify where you want to download all required game files ";
