...
using SBRW.Launcher.App.Classes.SystemPlatform;
...
namespace SBRW.Launcher.App.Classes.LauncherCore.Downloader
{
    public class Downloader
    {
        ...
        private ProgressUpdated mProgressUpdated { get; set; }
        private DownloadFinished mDownloadFinished { get; set; }
        private DownloadFailed mDownloadFailed { get; set; }
        private ShowMessage mShowMessage { get; set; }
        private ShowExtract mShowExtract { get; set; }
