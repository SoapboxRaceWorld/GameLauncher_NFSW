...
namespace SBRW.Launcher.App.Classes.LauncherCore.Global
{
    class Locations
    {
        ...
        public static string LauncherCustomServers { get { return Path.Combine(UnixOS.Detected() ? LauncherDataFolder : RoamingAppDataFolder_Launcher, NameNewServersJSON); } }
